...
{
    public abstract class AbstractWhipProjectile : ModProjectile
    {
        ...
        {
            Projectile.damage = (int)(Projectile.damage * (1f - DamageDecreasePerHit()));
            if (Tag() != -1)
            {
        ...
        public void FillWhipControlPoints(Projectile proj, List<Vector2> controlPoints)
        {
            ...
            float num7 = ContentSamples.ItemsByType[heldItem.type].useAnimation * 2 * num * player.whipRangeMultiplier;
        ...
        private void DrawWhip(Projectile proj)
        {
            ...
            for (int i = 0; i < list.Count - 1; i++)
            {
                ...
                Color color = Lighting.GetColor(vector.ToTileCoordinates(), Colour());
